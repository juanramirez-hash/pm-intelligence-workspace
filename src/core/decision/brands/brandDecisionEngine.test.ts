    ...
    customers: new Map([
      [
        'C001',
        {
          ...
          activePeriods: new Set(['2026-06', '2026-07']),
        },
      ],
      [
        'C002',
        {
          ...
          locations: new Set(['CDMX']),
          activePeriods: new Set(['2026-04', '2026-06']),
        },
      ],
    ]),
    ...
    products: new Map([
      [
        'P001',
        {
          ...
          sku: 'P001',
          brand: 'BRAND',
          firstSale: '2026-04-01',
          lastSale: '2026-07-01',
          revenue: 130,
          grossProfit: 39,
          quantity: 13,
          documents: 2,
          activePeriods: new Set(['2026-04', '2026-07']),
          brands: new Set(['BRAND']),
          customers: new Set(['C001']),
          locations: new Set(['CDMX']),
        },
