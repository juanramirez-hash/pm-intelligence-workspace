...
/**
 * Ejecuta consultas de la métrica revenue.
 */
export class RevenueExecutor implements CubeMetricExecutor {
  ...
  public execute(
    ...
    if (
      ...
      throw new Error(
        'RevenueExecutor currently supports only groupBy "period" with periodGranularity "month".',
      );
    }
