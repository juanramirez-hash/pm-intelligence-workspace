...
const handleSaveName =
  async (
    ...
    try {
      ...
      setSuccessMessage(
        `Nombre actualizado para ${updated.email}.`,
      )
    } catch (updateError) {
      setError(
        updateError instanceof Error
                        ...
                        <td className="px-6 py-4">
                          ...
                          <div className="space-y-2">
                            <input
                              ...
                              placeholder="Nombre completo"
                              className="w-full min-w-52 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-violet-400"
                            />
                          ...
                          <div>
                            <button
                              ...
                              className="text-left text-sm font-semibold text-slate-900 transition hover:text-violet-700"
                            >
                              {user.name ??
                                'Sin nombre'}
                            </button>
