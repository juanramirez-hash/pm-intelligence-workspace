export interface PurchaseRequestStatusSummaryItem {
  status: string
  totalRequests: number
}

export interface NormalizedPurchaseRequestRow {
  requestKey: string
...
export interface PurchaseRequestDatasetSummary {
  periodStart: string | null
  periodEnd: string | null

  totalRequests: number
  requestsWithPurchaseOrder: number
  ...
  statuses: PurchaseRequestStatusSummaryItem[]
